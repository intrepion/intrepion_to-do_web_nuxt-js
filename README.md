...
This project is a To Do application built with Nuxt.js, set up for local development using Docker Compose and prepared for deployment to various cloud providers. The project uses TypeScript for type safety, includes comprehensive testing setups, and follows modern Vue.js development practices.
...
- Sets up the testing environment (Vitest and Playwright)
...
### Creating Composables (Vue Hooks)

1. Add new composables in `src/composables/`
